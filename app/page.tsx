   ...
   {/* bg-background */}
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-8 mt-14 text-center">
          ...
          <p className="text-sm md:text-1xl font-medium text-muted-foreground uppercase">Join Us In Our Mission To Recover Edible Food Destined For Landfill</p>
        </header>
        ...
        <div className="rounded-md bg-card p-6 shadow-lg sm:p-8 mb-6">
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm">
            <Link href="/winners" className="text-primary underline-offset-4 hover:underline uppercase">
