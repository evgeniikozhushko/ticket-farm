    ...
    <div className="h-full rounded-xl border bg-card p-4 shadow-sm">
      ...
      >
        <CarouselContent className="h-full">
              ...
              <div className="min-h-0 flex-1 overflow-y-auto p-4 pr-5">
                <div className="mx-auto max-w-md py-1">
                  ...
                  <p className="mt-3 text-sm leading-6 text-muted-foreground">
                    Congratulations, {previewTicket.name}. You have been
                    selected for a ticket from {previewTicket.orgName}.
                  </p>
          ...
          {/* Slide 2 — delivery status */}
          <CarouselItem className="h-full">
            <div className="h-full min-h-0 overflow-hidden rounded-lg border bg-muted/30 p-4">
